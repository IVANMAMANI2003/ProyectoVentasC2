...
public class MenuFrame extends JFrame{
    ...
    ImplClientes metodos = new ImplClientes();
    ...
    public void menu(){
     JMenuBar menuBar = new JMenuBar();
        ...
        JMenuItem menuMantenimientoAdmin = new JMenuItem();
        ...
        menuMantenimientoAdmin.setText("Add-Admninistradores");
        ...
        menuCustomer.add(menuMantenimientoAdmin);
        ...
        menuMantenimientoViewProducts.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
        ...
        menuMantenimientoAdmin.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent e){
                  
                    AdminJDialog registro = new AdminJDialog(null, rootPaneCheckingEnabled);
                 registro.show();
                }
            }
        );
