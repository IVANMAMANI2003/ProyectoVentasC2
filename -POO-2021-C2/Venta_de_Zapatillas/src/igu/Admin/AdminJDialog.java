...
public class AdminJDialog extends javax.swing.JDialog {
    ...
    ImplAdmin metodos = new ImplAdmin();
    ...
    private void initComponents() {
        ...
        jPanel1.getAccessibleContext().setAccessibleName("Administradores");
        ...
        /*
          ...
          -*/                                                                               
            ...
            modelo.addColumn("Codigo");
                ...
                for (Persona pers : metodos.reporteAdmin()) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AdminJDialog dialog = new AdminJDialog(new javax.swing.JFrame(), true);
